...
Original file is located at
    https://colab.research.google.com/drive/1t7NsSi1lelCzExTv5eLfhGqy-mnm3JSD
"""
...
import os
os.chdir('/content/gdrive/MyDrive/iss/IRS/PM/')
!ls
...
data = pd.read_excel('FoodDatabase v1.8.xlsx')
data
...
bmr = BMR_calculate(1, 1, 172, 55, 24, 1)
nutrients = Food(bmr)
nutrients[i]
...
def main():
    ...
    for i in range(0, len(data)):
        food[i] = solver.NumVar(0.0, solver.infinity(), data['Food Name'][i])     # 定义变量：最小值，最大值，名称
        objective.SetCoefficient(food[i], data['na'][i])                            # 定义目标函数的变量的系数
    ...
    for i in range(0, len(nutrients)):
        ...
        constraints[0].SetCoefficient(food[j], data['cal'][j])
